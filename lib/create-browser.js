...
module.exports = async function browser ({
  ...
  log('new browser', { proxy, headless, width, height, slowMo, timeout }, args)
  return {
    async newPage (url) {
      ...
      if (proxy) await setProxy(page, { url, stylesheets, javascript, images })
...
async function setProxy (page, { url, timeout, stylesheets, javascript, images } = {}) {
  log('using proxy', url)
