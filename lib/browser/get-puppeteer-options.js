...
module.exports = function getPuppeteerOptions (options = {}) {
  ...
  if (options.browserWSEndpoint) {
    log('browserWSEndpoint', options.browserWSEndpoint)
    if (process.env.BROWSER_WS_ENDPOINT) options.browserWSEndpoint = process.env.BROWSER_WS_ENDPOINT
    Object.assign(puppeteerOptions, { browserWSEndpoint: options.browserWSEndpoint })
  }
