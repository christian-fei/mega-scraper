...
module.exports = async function preparePage (page, options = {
  ...
  if (options.proxySingleRequests || (!options.images || !options.javascript || !options.stylesheets)) {
...
async function setupRequestInterception (page, options = {}) {
  ...
  async function interceptRequest (interceptedRequest) {
    ...
    try {
      ...
      if (options.proxySingleRequests && (typeof options.proxy === 'object' && (options.proxy.host || options.proxy.endpoint))) {
